...
const MISSIONS = [
  ...
  { t: 'Entrá a una carpeta', d: 'Entrá a la carpeta proyectos.', c: 'cd proyectos',
  ...
  { t: 'Editá con nano', d: 'Abrí notas.txt, agregá una línea, guardá con Ctrl+S y salí con Ctrl+X.', c: 'nano notas.txt',
    w: 'En el celular usá los botones ^S y ^X de abajo del editor. En vim sería Esc y :wq.',
    ok: () => !!S.flags.nano },
  ...
  { t: 'Matá un proceso', d: 'Detené el node server.js usando su PID.', c: 'kill 2048',
